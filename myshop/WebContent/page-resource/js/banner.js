...
function IMGS(id,w,h,da,c){
  ...
  if(typeof c =="undefined"){
    this.c={bg:"#008DFD",color:"#FFFFFF",cbg:"#FFFFFF",ccolor:"#008DFD",bc:"#ccc",step:2500}
  }else{
    this.c=c;
  }
...
IMGS.prototype={
  init:function(){
    ...
    for(var i=this.l-1;i>=0;i--){
	  ...
	  div.innerHTML=(i+1);
	  div.style.cssText="float:right;width:20px;height:18px;margin-right:5px;border:1px solid "+this.c.bc+";line-height:18px;text-align:center;";
	  if(i>0){
